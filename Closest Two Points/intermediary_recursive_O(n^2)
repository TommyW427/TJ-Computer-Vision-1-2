...
//Part 2 Intermediary Recursive Approach O(n^2)
...
vector<point> recur(vector<point> &section, int i, int j) {
    vector<point> toReturn;
    //if (i==j or i<0 or j>section.size()) {
    //    return toReturn;
    //}
    if (j-i==1) {
        toReturn.push_back(section.at(i));
        toReturn.push_back(section.at(j));
        ...
        if (d2<d1) {
            if (d3<d2) {
                toReturn.push_back(section.at(i+1));
                toReturn.push_back(section.at(j));
            }
            else {
                toReturn.push_back(section.at(i));
        ...
        vector<point> won = recur(section,i,mid);
        vector<point> too = recur(section,mid+1,j);
        double wonD = checkDistance(won);
        double tooD = checkDistance(too);

        vector<point> minVect;
        double minDist; 
...
vector<point> part2() {
    ...
    chrono::time_point<chrono::system_clock> start, end;
    start = chrono::system_clock::now();
    sort(ptsVector.begin(),ptsVector.end());
    ptsVector = recur(ptsVector,0,ptsVector.size()-1);
    end = chrono::system_clock::now();
    t2 = end-start;
    return ptsVector;
}
...
int main() {
    ...
    //vector<point> p1 = part1();
    vector<point> p2 = part2();
    p1 = p2;
    
    results << "PART 1\n";
    results << "Closest Points: " << p1[0].toString() << " " << p1[1].toString() << "\n";
    results << setprecision(17) << "Smallest Distance: " << p1[0].distanceTo(p1[1]) << "\n";
    results << setprecision(17) << "Time taken for part1: " << t1.count() << "\n";
    results << "PART 2\n";
    results << "Closest Points: " << p2[0].toString() << " " << p2[1].toString() << "\n";
    results << setprecision(17) << "Smallest Distance: " << p2[0].distanceTo(p2[1]) << "\n";
    results << setprecision(17) << "Time taken for part2: " << t2.count() << "\n";
    cout << "PART 1\n";
    cout << "Closest Points: " << p1[0].toString() << " " << p1[1].toString() << "\n";
    cout << "Smallest Distance: " << setprecision(17) << p1[0].distanceTo(p1[1]) << "\n";
    cout << "Time taken for part1: " << t1.count() << "\n";
    cout << "PART 2\n";
    cout << "Closest Points: " << p2[0].toString() << " " << p2[1].toString() << "\n";
    cout << setprecision(17) << "Smallest Distance: " << p2[0].distanceTo(p2[1]) << "\n";
    cout << setprecision(17) << "Time taken for part2: " << t2.count() << "\n";
